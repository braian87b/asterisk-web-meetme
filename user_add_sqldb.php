...
<body>
    ...
    <?php if (($add || $update) && (intval($conflict) == 0) && !($remove)) {
        if (!strlen($Error)) { ?>
            <center><strong> <?php echo _("User Created"); ?>: </strong></center><br>
            <center><?php echo _("User Name"); ?>: <?php echo $fname . " " . $lname ?> <br></center>
            <center><?php echo _("User Email"); ?>: <?php echo $userEmail ?> <br></center>
            <center><?php echo _("Is Admin"); ?>: <?php echo $isAdmin  ?><br></center>

            <FORM METHOD=POST ACTION="./meetme_control.php?&s=3&t=1" target="_top">
                <center><INPUT TYPE="Submit" VALUE="<?php echo _("Continue") ?>" /></center>
            </FORM>
        <?php } else { ?>
    ...
    <?php if ($remove) { ?>
        ...
        <center><strong> <?php echo _("User Deleted"); ?> </strong></center><br>
        <FORM METHOD=POST ACTION="./meetme_control.php?&s=3&t=1" target="_top">
            <center><INPUT TYPE="Submit" VALUE="<?php echo _("Continue") ?>" /></center>
        </FORM>
    ...
    <?php if ((intval($conflict) != 0)) { ?>
        <center><strong> <?php echo _("User Not Created"); ?>: </strong></center><br>
    <?php } ?>
    <br><br>
</body>
