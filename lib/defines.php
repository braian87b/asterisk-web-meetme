...
?> <table width="90%">
    <tr>
        <td couluns=2><br>
            <h1><?php echo _("Support Team"); ?> ...</h1>
        </td>
    </tr>
    <tr>
        <td><em><strong><?php echo _("Contact") ?>: </strong></em>random author</td>
        <td><em><strong><?php echo _("Phone") ?>: </strong></em>random telephone</td>
    </tr>
    <tr>
        <td span=2><br>
            <h2><?php echo _("Developer Team"); ?> ...</h2>
        </td>
    </tr>
    <tr>
        <!-- <td><a href="mailto:areski@gmail.com">Arezqui Bela&iuml;d</a></td>
        <td><a href="mailto:dan_austin@phoenix.com">Dan Austin </a></td> -->
        <td><a href="mailto:email@mydomain.com">random author</a></td>
    </tr>
    <tr>
    ...
    <tr>
        <td> <?php echo _("Currently logged on as"); ?> <?php echo $_SESSION['userid'] ?> a
            <?php echo $_SESSION['privilege'] ?> <?php if (isset($_SESSION['groups'])) echo _("and a member of"); ?>
            <?php if (isset($_SESSION['groups'])) echo $_SESSION['groups'] ?> </td>
    </tr>
</table>
<br><br> <?php
}
