...
<div id="fedora-middle-one">
    ...
    <div id="fedora-content">
        <center>
            ...
            <h2><?php echo _("Please enter the conference number and pin") . ":"; ?></h2>
            <FORM METHOD=POST NAME="WMLogon" ACTION="<?php echo $php_self ?>">
                <INPUT TYPE="hidden" NAME="current_page" value=0>
                <table class="bar-status" width="35%" border="0" cellspacing="1" cellpadding="2" align="center">
                    <tbody>
                        <tr>
                            <td align="left" bgcolor="#000033">
                                <font face="verdana" size="1" color="#ffffff"><b>&nbsp;&nbsp;<?php echo _("Conference #"); ?> :</b></font>
                            </td>
                            <td class="bar-search" align="center" bgcolor="#acbdee">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td>&nbsp;&nbsp;<INPUT tabindex="100" TYPE="text" NAME="confno" value="<?php echo $_SESSION['confno']; ?>"></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                        <td align="left" bgcolor="#000033">
                            <font face="verdana" size="1" color="#ffffff"><b>&nbsp;&nbsp;<?php echo _("Pin"); ?> :</b></font>
                        </td>
                        <td class="bar-search" align="center" bgcolor="#acbdee">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td>&nbsp;&nbsp;<INPUT tabindex="101" TYPE="password" NAME="pin" value="<?php echo $_SESSION['pin']; ?>"></td>
                                </tr>
                            </table>
                        </td>
                        </tr>
                        <tr>
                            ...
                            <td class="bar-search" align="center" bgcolor="#cddeff">
                                <input tabindex="102" type="Submit" name="Find" align="top" border="0" value="Find " />
                            </td>
                        </tr>
                    </tbody>
                </table>
