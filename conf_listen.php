    ...
    <center>
        <?php if (is_array($list) && $_SESSION['auth']) { ?>
            <table width="<?php echo $FG_HTML_TABLE_WIDTH; ?>" border="0" align="center" cellpadding="0" cellspacing="0">
                ...
                <?php } else { ?>
                    <a href="./meetme_control.php?s=2&t=0&bookId=<?php echo "$recordset[5]\" target=\"_top\">" . stripslashes($record_display); ?></a>
        </TD>
                            ...
                            <TR>
                                <TD align="right"><SPAN style="COLOR: #ffffff; FONT-SIZE: 11px"><B>
                                            <?php if ($current_page > 0) { ?>
                                                ...
                                                <a href="<?php echo "$php_self?s=1&t=0&order=$order&view=$view&sens=$sens&current_page=" . $current_page - 1 . "\">"; ?> 
                    <?php print _("Previous"); ?> </a> - 
                    <?php
                                            }
                                            echo ($current_page + 1) . " / " . $nb_record_max;
                                            if ($current_page < $nb_record_max - 1) {
                                                echo "- <a href=\"$php_self?s=2&t=2&order=$order&view=$view&sens=$sens&current_page=" . $current_page + 1;
                                                ">";
                    ?> 
