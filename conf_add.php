...
<head>
    ...
    <script language="JavaScript" type="text/JavaScript">
        ...
        var Submitted = false;
        var addContinue = "<?php echo _("Add Conference"); ?>";
    </script>
</head>
        ...
        <script language="javascript">
            function ClientMailer() {
                ...
                if (cMailer._Subject.value == "")
                    cMailer._Subject.value = "<?php echo _("Your Conference Details"); ?>";
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="bar-search" align="center" bgcolor="#acbdee">
                                    ...
                                    <b><?php echo _("Send conference call details and the message you enter below"); ?></b>
                                </td>
                            </tr>
                            <tr>
                                <td align="left" bgcolor="#000033" width="20%">
                                    <font face="arial" size="1" color="#ffffff">&nbsp;&nbsp;<b><?php echo _("Email Message") . ":"; ?></b></font>
                                </td>
                                <td class="bar-search" align="center" bgcolor="#acbdee">
                                    <?php
                                    if (MAILER == "SERVER") {
        ...
        <?php
                            ...
                            <tr>
                                ...
                                <td class="bar-search" align="center" bgcolor="#acbdee">
                                    ...
                                    if (MAILER == "SERVER") {
                                    ?>
                                        <input type=submit value=<?php echo "\"" . _("email participants") . "\""; ?> class=bstandard>
                                    <?php
                                    } else {
                                    ?>
                                        <input type=button value=<?php echo "\"" . _("email participants") . "\""; ?> onClick="ClientMailer()" class=bstandard>
                                    <?php
                                    }
                                    ?>
                ...
                <?php if (isset($confno) && isset($error)  && !isset($Extend)) { ?>
                    <center><strong> <?php echo _("Conference Not Scheduled") . ":"; ?> </strong></center><br>
