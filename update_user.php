...
<div id="fedora-middle-two">
    ...
    <div id="fedora-content">
        ...
        <br />
        <center>
            <?php echo _("Enter the details about the user to add"); ?>
            <?php if ($_SESSION['privilege'] == 'Admin') { ?>
                <FORM METHOD=POST NAME="WMAdd" ACTION="user_add_<?php echo AUTH_TYPE; ?>.php?&s=3&t=0&order=<?php echo $order ?>&sens=<?php echo $sens ?>&current_page=<?php echo $current_page ?>" target="superframe">
                    ...
                    <table class="bar-status" width="60%" border="0" cellspacing="1" cellpadding="2" align="center">
                        <tbody>
                            <tr>
                                <td align="left" bgcolor="#000033">
                                    <font face="verdana" size="1" color="#ffffff"><b>&nbsp;&nbsp;<?php echo _("First Name"); ?> :</b></font>
                                </td>
                            ...
                            <tr>
                                <td align="left" bgcolor="#000033">
                                    <font face="verdana" size="1" color="#ffffff"><b>&nbsp;&nbsp;<?php echo _("Last Name"); ?> :</b></font>
                                </td>
                                <td class="bar-search" align="center" bgcolor="#acbdee">
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                            ...
                            <tr>
                                <!-- note this additional row here on the left -->

                            <tr>
                                <td align="left" bgcolor="#000033">
                                    <font face="verdana" size="1" color="#ffffff"><b>&nbsp;&nbsp;<?php echo _("User Email"); ?> :</b></font>
                                </td>
                                <td class="bar-search" align="center" bgcolor="#acbdee">
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                            ...
                            <tr>
                                <td align="left" bgcolor="#000033">
                                    <font face="verdana" size="1" color="#ffffff"><b>&nbsp;&nbsp;<?php echo _("Telephone"); ?> :</b></font>
                                </td>
                                <td class="bar-search" align="center" bgcolor="#acbdee">
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                            ...
                            <tr>
                                <td align="left" bgcolor="#000033">
                                    <font face="verdana" size="1" color="#ffffff"><b>&nbsp;&nbsp;<?php echo _("Password"); ?> :</b></font>
                                </td>
                                <td class="bar-search" align="center" bgcolor="#acbdee">
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td>&nbsp;&nbsp;<INPUT TYPE="password" NAME="userPass" value="<?php echo $password ?>"></td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td align="left" bgcolor="#000033">
                                    <font face="verdana" size="1" color="#ffffff"><b>&nbsp;&nbsp;<?php echo _("Is Admin"); ?>? :</b></font>
                                </td>
                                <td class="bar-search" align="center" bgcolor="#acbdee">
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td>&nbsp;&nbsp;
                                                <INPUT TYPE="radio" NAME="userAdmin" value="0" <?php if (!$userAdmin) echo 'checked'; ?>> <?php echo _("No"); ?>
                                                <br />&nbsp;&nbsp;
                                                <INPUT TYPE="radio" NAME="userAdmin" value="1" <?php if ($userAdmin) echo 'checked'; ?>> <?php echo _("Yes"); ?>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="bar-search" align="center" bgcolor="#cddeff">
                                    <?php if ($email) { ?>
                                        <input type="Submit" name="update" align="top" border="0" value="<?php echo _("Update User"); ?>" onclick="if(confirm('<?php echo _("Are you sure"); ?>?'))return true; else return false;">
                                        <input type="Submit" name="remove" align="top" border="0" value="<?php echo _("Remove User"); ?>" onclick="if(confirm('<?php echo _("Are you sure"); ?>?'))return true; else return false;">
                        ...
                        <?php } else { ?>
                            <br><br>
                            <b><?php echo _("You Are not an Administrator of this system"); ?>. </b>
                        <?php } ?>
