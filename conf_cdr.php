                            ...
                            <TR>
                                <TD align="right"><SPAN style="COLOR: #ffffff; FONT-SIZE: 11px"><B>
                                            <?php if (isset($current_page) && $current_page > 0) { ?>
                                                ...
                                                <a href="<?php
                                                            echo "$php_self?order=$order&sens=$sens&current_page=" . ($current_page - 1);
                                                            echo "&bookId=$bookId&confno=$confno";
                                                            ?>">
                                                    Previous </a> -
                                            <?php } ?>
                                            ...
                                            <?php if (isset($current_page) && $current_page < $nb_record_max - 1) { ?>
                                                - <a href="<?php
                                                            echo "$php_self?order=$order&view=$view&sens=$sens&current_page=" . ($current_page + 1);
                                                            echo "&bookId=$bookId&confno=$confno";
                                                            ?>">
