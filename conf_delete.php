    ...
    <script language="JavaScript" type="text/JavaScript">
        ...
        function select_all(name) {
            if (checkflag == "false") {
                ...
                checkflag = "true";
                return <?php echo "\"" . _("Uncheck All") . "\""; ?>;
            } else {
                            for (i = 0; i < name.length; i++) {
                name[i].checked = false; 
                            }
                                checkflag = "false";
                                return <?php echo "\"" . _("Check All") . "\""; ?>;
            }
        }
...
<body>
    ...
    <center>
        <?php if (is_array($list) && (!defined('AUTH_TYPE') || $_SESSION['auth'])) { ?>
                ...
                <TR bgcolor="#ffffff">
                    <TD bgColor=#7f99cc height=16 style="PADDING-LEFT: 5px; PADDING-RIGHT: 3px">
                        <TABLE border=0 cellPadding=0 cellSpacing=0 width="100%">
                            ...
                            <FORM METHOD="POST" id="deleteConf" ACTION="<?php echo $php_self ?>">
                        </TABLE>
                    </TD>
                </TR>
                <TR>
                    <TD>
                                            ...
                                            <TD width="<?php echo $FG_TABLE_COL[$i][2]; ?>" align=middle class="tableBody" style="PADDING-BOTTOM: 2px; PADDING-LEFT: 2px; PADDING-RIGHT: 2px; PADDING-TOP: 2px">
                                                <center><strong>
                                                        <?php if (strtoupper($FG_TABLE_COL[$i][4]) == "SORT") { ?>
                                                            <a href="<?php
                                                                        echo "$php_self?s=1&t=0&current_page=$current_page&order=" . $FG_TABLE_COL[$i][1] . "&sens=";
                                                                        echo "DESC" ? $sens == "ASC" : "ASC";
                                                                        echo "&confno=$confno";
                                                                        echo "";
                                                                        ?>">
                                ...
                                <?php for ($i = 0; $i < $FG_NB_TABLE_COL; $i++) { ?>
                                    ...
                                    <?php $record_display = $recordset[$i];
                                        ...
                                        <TD width="<?php echo $FG_TABLE_COL[$i][2]; ?>" vAlign=middle align="<?php echo $FG_TABLE_COL[$i][3]; ?>" class=tableBody>
                                            <INPUT TYPE=CHECKBOX NAME="DeletebyId[]" VALUE="<?php echo $recordset[5] ?>"><?php echo stripslashes($record_display); ?>
                                        </TD>
                                    <?php } else { ?>
                        ...
                        <TR>
                            <TD class=tableDivider colSpan=<?php echo $FG_TOTAL_TABLE_COL + 1; ?>><IMG height=1 src="images/clear.gif" width=1></TD>
                                ...
                                <TR>
                                    <TD align="right"><SPAN style="COLOR: #ffffff; FONT-SIZE: 11px"><B>
                                                <?php if ($current_page > 0) { ?>
                                                    ...
                                                    <a href="<?php
                                                                echo "$php_self?s=1&t=0&order=$order&sens=$sens&current_page=" . ($current_page - 1);
                                                                ?><?php if (isset($confno)) echo "&confno=$confno"; ?>">
            ...
            <INPUT TYPE="Button" VALUE=<?php echo "\"" . _("Check All") . "\""; ?> onclick="this.value=select_all(this.form['DeletebyId[]'])">
            <INPUT TYPE="Submit" NAME="DeleteNow" VALUE=<?php echo "\"" . _("Delete Selected") . "\""; ?> onClick="if(!confirm('<?php echo _("Are you sure") . "?"; ?>')) return false">
            </FORM>
