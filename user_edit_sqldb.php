                                ...
                                <?php for ($i = 0; $i < $FG_NB_TABLE_COL; $i++) { ?>
                                    ...
                                    <?php if ($i == 0) { ?>
                                        <TD width="<?php echo $FG_TABLE_COL[$i][2] ?>" vAlign=middle align="<?php echo $FG_TABLE_COL[$i][3] ?>" class=tableBody>
                                            <a href="./update_user.php?userEmail=<?php echo $recordset[0] ?>&uuid=<?php echo $recordset[2] ?>" target="_top">
                            ...
                            <TR>
                                <TD align="right"><SPAN style="COLOR: #ffffff; FONT-SIZE: 11px"><B>
                                            <?php if ($current_page > 0) { ?>
                                                ...
                                                <a href="<?php echo "$php_self?s=1&t=0&order=$order&view=$view&sens=$sens&current_page=" . ($current_page - 1) . "&confno=$confno"; ?>">
                                                    <?php print _("Previous"); ?> </a> -
                                            <?php } ?>
                                            <?php echo ($current_page + 1); ?> / <?php echo $nb_record_max; ?>
                                            <?php if ($current_page < $nb_record_max - 1) { ?>
                                                -
                                                <a href="<?php echo "$php_self?s=2&t=2&order=$order&view=$view&sens=$sens&current_page=" . ($current_page + 1) . "&confno=$confno"; ?>">
