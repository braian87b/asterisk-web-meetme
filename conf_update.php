...
<body>
    ...
    <center>
                                            ...
                                            <TD width="<?php echo $FG_TABLE_COL[$i][2]; ?>" align=left class="tableBody" style="PADDING-BOTTOM: 2px; PADDING-LEFT: 2px; PADDING-RIGHT: 2px; PADDING-TOP: 2px">
                                                <strong>
                                                    <?php if (strtoupper($FG_TABLE_COL[$i][4]) == "SORT") { ?>
                                                        <a href="<?php
                                                                    echo "$php_self?s=$s&t=$t&view=$view&current_page=$current_page&order=" . $FG_TABLE_COL[$i][1] . "&sens=";
                                                                    echo "DESC" ? $sens == "ASC" : "ASC";
                                                                    if (strlen($confno)) echo "&confno=$confno";
                                                                    echo "\""; ?>">
                                                            <span class="liens">
                                                            <?php
                                                        }
                                        ...
                                        <TD width="<?php echo $FG_TABLE_COL[$i][2]; ?>" vAlign=middle align="<?php $FG_TABLE_COL[$i][3]; ?>" class=tableBody>
                                            ...
                                            ?>
                                                <a href="./meetme_control.php?s=1&t=0&confno=<?php
                                                                                                echo $recordset[0];
                                                                                                echo "&book=$recordset[5]"; ?>" target="_top">
                                                    <?php echo stripslashes($record_display); ?></a>
                                        </TD>
        ...
        <TR>
            <TD class=tableDivider colSpan=<?php $FG_TOTAL_TABLE_COL + 1; ?>><IMG height=1 src="images/clear.gif" width=1></TD>
                            ...
                            <TR>
                                <TD align="right"><SPAN style="COLOR: #ffffff; FONT-SIZE: 11px"><B>
                                            ...
                                            ?>
                                                ...
                                                <a href="<?php echo "$php_self?s=1&t=0&order=$order&view=$view&sens=$sens&current_page=$prev_page&confno=$confno"; ?>">
                                            ...
                                            ?>
                                                <a href="<?php echo "$php_self?s=2&t=2&order=$order&view=$view&sens=$sens&current_page=$next_page&confno=$confno"; ?>">
                                                    <?php print _("Next"); ?> </a>

                                                <img src=" images/fleche-d.gif" width="5" height="10">
                                        </B></SPAN>
                                <?php } ?>
                                </TD>
                            </TR>
