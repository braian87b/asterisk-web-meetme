...
<head>
    <title><?php echo GUI_TITLE;
            echo _("control"); ?></title>
...
<body BGCOLOR="#d9d9d9">
    ...
    <div id="fedora-header">
        ...
        <div id="fedora-header-logo">
            <table border="0" cellpadding="0" cellspacing="0">
                <tr>
                    <td><img src="images/asterisk.gif" alt="CDR (Call Detail Records)"></td>
                    <td>
                        <H1>
                            <font color=#990000>&nbsp;&nbsp;&nbsp;<?php echo GUI_TITLE;
                                                                    echo _("Control"); ?></font>
                        </H1>
                    </td>
                </tr>
    ...
    <div id="fedora-side-left">
        <div id="fedora-side-nav-label"><?php echo _("Site Navigation") . ":" ?></div>
        <ul id="fedora-side-nav">
            ...
            while ($i < sizeof($nkey)) {
                ...
                $arr = $array[$nkey[$i]];
                if (is_array($arr)) {
                    echo "\n\t<li>$op_strong<a href=\"$php_self?s=$i\">" . $nkey[$i] . "</a>$cl_strong";
                    ...
                    while ($j < sizeof($arr)) {
                        ...
                        echo "<ul>";
                        echo "\n\t<li>$op_strong<a href=\"$php_self?s=$i&t=$j\">" . $array[$nkey[$i]][$j] . "</a>$cl_strong";
                        echo "</ul>";
                        $j++;
                    }
                } else {
                    echo "\n\t<li>$op_strong<a href=\"$php_self?s=$i\">" . $array[$nkey[$i]] . "</a>$cl_strong";
                }
                echo "</li>\n";
...
<div id="fedora-middle-two">
    ...
    <div id="fedora-content">
        ...
        <?php if ($section == "section0") { ?>
            ...
            <h1>
                <div style="text-align: center;"><?php echo GUI_TITLE; ?> <?php echo _("Control") ?></div>
            </h1>

            <?php echo _("Intro-Text-About"); ?>
            ...
            <br><br>
            <h3><?php echo _("Screen-shot"); ?></h3>
            <a href="images/Screenshot-0.png"><img src="images/Screenshot-0.png" width=650 alt="<?php echo GUI_TITLE; ?> Control"></a>
            <br><br>

            <a href="images/Screenshot-1.png"><img src="images/Screenshot-1.png" width=650 alt="<?php echo GUI_TITLE; ?> Control"></a>
            <br><br>

        <?php } elseif ($section == "section1") { ?>
            <h1><?php echo _("Developer team ..."); ?></h1>
            <br>
            <table width="90%">
                ...
                <tr>
                    <td>
                        <a href='javascript:bite("3721 945 4728 2762 3565 3554 2008 1380 654 3721 3554 4468 3007 3877 4828 654",5123,2981)'><?php echo _("Click to email me"); ?></a>

                    </td>
                </tr>

            </table>
            <br><br><em><strong><?php echo _("Last update") . ":"; ?></strong></em> <?php echo $update ?><br>

        <?php } else { ?>
            <h1><?php echo _("Coming soon") . " ..."; ?></h1>
